...
import type { SitesListFilters, EntityStatus, Client, Region } from '@/features/orgStructure/types/orgStructure.types';

export interface SitesFiltersBarProps {
  filters: SitesListFilters;
  clients: Client[];
  regions: Region[];
  onChange: (filters: SitesListFilters) => void;
}
...
export function SitesFiltersBar({ filters, clients, regions, onChange }: SitesFiltersBarProps) {
  return (
